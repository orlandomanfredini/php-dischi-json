        ...
        <div class="container">
            <div class="row">
                <div v-for="music in content" class="col-4">
                    <div class="card" @click="visible(music)">
                    ...
                    <div class="modal" v-if="modal">
                        <div class="container-modal">
                           <i class="fa-solid fa-x icon" @click="close"></i>
                           <div class="row-modal">
                              <div class="col-modal">
                                  <img class="poster" :src="musicObject.poster" alt="">
                                  <h5 class="title"><strong>{{musicObject.title}}</strong></h5>
                                  <div>{{musicObject.author}}</div>
                                  <h4>{{musicObject.year}}</h4>
                              </div>
                           </div>
                        </div>
                    </div>
